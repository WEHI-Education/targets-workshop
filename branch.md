...
✔ ended pipeline [204ms, 1 completed, 3 skipped]
```
...
✔ ended pipeline [342ms, 7 completed, 4 skipped]
```
...
✔ ended pipeline [316ms, 5 completed, 3 skipped]
```
...
✔ penguins_data completed [71ms, 1.53 kB]
+ combined_summary dispatched
...
✔ ended pipeline [422ms, 9 completed, 2 skipped]
```
