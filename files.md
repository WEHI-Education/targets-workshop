...
``` output
✔ skipped pipeline [173ms, 1 skipped]
```
...
✔ ended pipeline [397ms, 2 completed, 0 skipped]
```
...
✔ penguins_data_raw completed [140ms, 10.40 kB]
+ penguins_data dispatched
✔ penguins_data completed [25ms, 1.49 kB]
✔ ended pipeline [414ms, 3 completed, 0 skipped]
```
