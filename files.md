...
✔ ended pipeline [293ms, 1 completed, 0 skipped]
```
...
``` output
✔ skipped pipeline [160ms, 1 skipped]
```
...
✔ ended pipeline [342ms, 2 completed, 0 skipped]
```
...
✔ penguins_data_raw completed [124ms, 10.40 kB]
+ penguins_data dispatched
✔ penguins_data completed [22ms, 1.49 kB]
✔ ended pipeline [375ms, 3 completed, 0 skipped]
```
...
✔ ended pipeline [377ms, 4 completed, 0 skipped]
```
