...
✔ ended pipeline [336ms, 1 completed, 0 skipped]
```
...
``` output
✔ skipped pipeline [183ms, 1 skipped]
```
...
✔ ended pipeline [394ms, 2 completed, 0 skipped]
```
...
✔ penguins_data_raw completed [143ms, 10.40 kB]
+ penguins_data dispatched
✔ penguins_data completed [24ms, 1.50 kB]
✔ ended pipeline [419ms, 3 completed, 0 skipped]
```
...
✔ ended pipeline [428ms, 4 completed, 0 skipped]
```
